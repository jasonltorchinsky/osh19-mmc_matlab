...
% Non-dimensional EOFs
nccreate(eofs_file, 'eof1',...
    'Datatype', 'double',...
    'Format', 'netcdf4',...
    'Dimensions', {'2x', 2*nx});
ncwriteatt(eofs_file, 'eof1', 'description', ...
    'Non-dimensional EOF1');
ncwriteatt(eofs_file, 'eof1', 'units', 'N/A');
ncwrite(eofs_file, 'eof1', eofs.eof1);

nccreate(eofs_file, 'eof2',...
    'Datatype', 'double',...
    'Format', 'netcdf4',...
    'Dimensions', {'2x', 2*nx});
ncwriteatt(eofs_file, 'eof2', 'description', ...
    'Non-dimensional EOF2');
ncwriteatt(eofs_file, 'eof2', 'units', 'N/A');
ncwrite(eofs_file, 'eof2', eofs.eof2);
...
ncwriteatt(eofs_file, 'exp1', 'description', ...
    'Expansion coefficients for EOF1');
...
ncwriteatt(eofs_file, 'exp2', 'description', ...
    'Expansion coefficients for EOF2');
...
ncwriteatt(eofs_file, 'u_mjo1', 'description', ...
    'Zonal wind of reconstructed MJO1');
...
ncwriteatt(eofs_file, 'u_mjo2', 'description', ...
    'Zonal wind of reconstructed MJO2');
...
ncwriteatt(eofs_file, 'q_mjo1', 'description', ...
    'Moisture of reconstructed MJO1');
...
ncwriteatt(eofs_file, 'q_mjo2', 'description', ...
    'Moisture of reconstructed MJO2');
