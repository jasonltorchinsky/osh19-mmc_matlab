...
params_out.gamma   = params_out.gamma / months_to_secs;
params_out.a       = params_out.a / months_to_secs;
params_out.w_u_hat = params_out.w_u_hat / months_to_secs;

params_out.sigma_u = params_out.sigma_u / months_to_secs^(1/2);
params_out.sigma_v = params_out.sigma_v / months_to_secs^(1/2);
params_out.sigma_w = params_out.sigma_w / months_to_secs^(3/2);
